...
function theme_assets()
{
    ...
    wp_enqueue_script('jquery-migrate', '//code.jquery.com/jquery-migrate-1.2.1.min.js', array('jquery'));
    ...
    // } 
    wp_enqueue_script('slider-script', THEME_DIR . '/js/slick.js', array('jquery'));
    wp_enqueue_script('lightbox-script', THEME_DIR . '/js/lightbox.js', array('jquery', 'slider-script'));
    wp_enqueue_style('lightbox-style', THEME_DIR . '/css/lightbox.css');

    wp_enqueue_style('main-style', THEME_DIR . '/css/theme.css');
    wp_enqueue_script('main-script', THEME_DIR . '/js/theme.js', array('jquery', 'bootstrap-script', 'slider-script'));
}
