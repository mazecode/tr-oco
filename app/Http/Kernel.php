...
class Kernel extends \TypeRocket\Http\Kernel
{
    public $middleware = [
        ...
        'page' => [OwnsPostOrCanEditPosts::class],
        'comment' => [OwnsCommentOrCanEditComments::class],
        'option' => [CanManageOptions::class],
        'category' => [CanManageCategories::class],
        'tag' => [CanManageCategories::class],
        'contact' => [Middleware\VerifyNonce::class],
        'project' => [Middleware\VerifyNonce::class]
    ];
}
