 ...
 */
  ...
  function getOffsetRectRelativeToArbitraryNode(children, parent) {
    ...
    if (isHTML || parent.nodeName === 'BODY') {
      ...
      let borderLeftWidth = isIE10 && isHTML ? 0 : +styles.borderLeftWidth.split('px')[0];
      let marginTop = isIE10 && isHTML ? 0 : +styles.marginTop.split('px')[0];
  ...
  function computeAutoPlacement(placement, refRect, popper, reference, boundariesElement) {
    ...
    let boundaries = getBoundaries(popper, reference, 0, boundariesElement);
    ...
    var computedPlacement = Object.keys(sides).sort((a, b) => {
  ...
  function parseOffset(offset, popperOffsets, referenceOffsets, basePlacement) {
    ...
    var divider = fragments.indexOf(find(fragments, (frag) => {
  ...
  function hide(data) {
    ...
    var bound = find(data.instance.modifiers, (modifier) => {
