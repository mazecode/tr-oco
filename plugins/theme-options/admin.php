...
<div class="typerocket-container">
    ...
    $mainPage = function () use ($form) {
        echo $form->image('Main Picture');
        echo $form->color('Main Color Picture');
        echo $form->text('Main Title');
        echo $form->select('Title Weight')->setOptions([
            'Thin' => 300,
            'Bold' => 900,
            'Normal' => 500
        ])->setSetting('default', 500);
        echo $form->text('Main Subtitle');
    };
